...
import cipungtes.aksesorisHpPage;
import cipungtes.aksesorisLainPage;
import cipungtes.aksesorisLaptopPage;
import cipungtes.dashbord;
import cipungtes.loginPage;
...
public class menu1 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("AVORAYA CELL");
        jLabel2.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(0, 153, 102)));
        ...
        jPanel2.setLayout(new java.awt.GridLayout(6, 1, 0, 20));
        ...
        buttonAksLaptop.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonAksLaptopActionPerformed(evt);
            }
        });
    ...
    private void buttonAksLaptopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAksLaptopActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_buttonAksLaptopActionPerformed
         ...
         buttonDashbord.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                    try {
                        ...
                        m.setVisible(true);
                        SwingUtilities.getWindowAncestor(menu1.this).dispose();
